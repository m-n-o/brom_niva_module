...
module fabm_niva_brom_bioplast
   ...
   type, extends(type_base_model), public :: type_niva_brom_bioplast
       ...
       type (type_diagnostic_variable_id)  :: id_het2det, id_het2biof, id_det2biof, id_det2het        
...
contains
   ...
   subroutine initialize(self, configunit)
      ...
      call self%register_diagnostic_variable(self%id_det2biof,'det2biof','g/m^3',  'det2biof: MP_det to MP_biof', output=output_time_step_integrated)
...
! Local 
       ...
       real(rk) :: free2het, het2det, het2biof, det2biof
...
! MP_free release from MP_detritus========================
       if (POM.gt.0.0000000001) then
           det2biof = max(0.0_rk,MP_det*(POM_decay_ox+POM_decay_denitr+Autolys)/POM)
       else
           det2biof = 0._rk
       endif
...
!        1 mg = 3.x10^6 items in wet weather
       MP_TOT_items = MP_TOT*2.0e6 
        dMP_free = Decay_MP_free - free2biof - free2het + biof2free
        dMP_biof = Decay_MP_biof + free2biof - biof2het  + het2biof - biof2free + det2biof
        dMP_het  = Decay_MP_het + free2het + biof2het + det2het - het2det - het2biof
        dMP_det  = Decay_MP_det + het2det  - det2biof - det2het
...
! Export diagnostic variables 
       ...
       _SET_DIAGNOSTIC_(self%id_det2biof,det2biof)   
